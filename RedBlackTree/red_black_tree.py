...
class RedBlackTree:
    ...
    Потом происходит балансировка дерева.
    '''
    ...
    поиска и вставки всегда была O(log(n))), надо при каждом добавлении или
    удалении элемента обрабатывать несколько возникаемых ситуаций.
